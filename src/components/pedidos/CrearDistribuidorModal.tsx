...
const labelStyle: CSSProperties = {
  ...
  color: '#303030', marginBottom: '6px',
};
const inputStyle: CSSProperties = {
  width: '100%', padding: '6px 10px', border: '1px solid #c9cccf',
  borderRadius: '8px', fontSize: '14px', color: '#303030',
...
export function CrearDistribuidorModal({ open, onClose, onSaved }: CrearDistribuidorModalProps) {
  ...
  const resetForm = useCallback(() => {
    setEmpresa(''); setCalle(''); setApartamento(''); setCodigoPostal('');
    setCiudad(''); setEstado(''); setContacto(''); setEmail(''); setTelefono('');
  }, []);
  ...
  const handleGuardar = useCallback(async () => {
    ...
    setSaving(true);
    try {
      const direccion = [calle, apartamento, ciudad, estado, codigoPostal]
        .filter(Boolean).join(', ');
    ...
    setSaving(false);
  }, [empresa, calle, apartamento, codigoPostal, ciudad, estado, contacto, email, telefono, addProveedor, showSuccess, showError, onSaved, resetForm, onClose]);
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          padding: '20px 24px 16px', borderBottom: '1px solid #e1e3e5',
        }}>
          <span style={{ fontSize: '16px', fontWeight: 600, color: '#1a1a1a' }}>Crear distribuidor</span>
          <button
            type="button"
            onClick={handleClose}
            style={{ background: 'none', border: 'none', cursor: 'pointer', padding: '4px', color: '#6d7175', display: 'flex', alignItems: 'center' }}
          >
        ...
        <div style={{ padding: '20px 24px', display: 'flex', flexDirection: 'column', gap: '16px' }}>
          ...
          <div>
            ...
            <div style={{ position: 'relative' }}>
              ...
              <svg style={{ position: 'absolute', right: '10px', top: '50%', transform: 'translateY(-50%)', pointerEvents: 'none', color: '#6d7175' }} width="16" height="16" viewBox="0 0 20 20" fill="none">
          ...
          <div>
            ...
            <div style={{ position: 'relative' }}>
              <svg style={{ position: 'absolute', left: '10px', top: '50%', transform: 'translateY(-50%)', color: '#6d7175', pointerEvents: 'none' }} width="16" height="16" viewBox="0 0 20 20" fill="none">
                <path d="M13 13l4 4M9 15A6 6 0 109 3a6 6 0 000 12z" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
              </svg>
              <input
            ...
            <div>
              ...
              <div style={{ display: 'flex', gap: '6px' }}>
                ...
                <div style={{
                  ...
                  padding: '0 10px', border: '1px solid #c9cccf', borderRadius: '8px',
                  background: '#fff', fontSize: '13px', cursor: 'default', height: '36px',
                }}>
        ...
        <div style={{
          ...
          padding: '16px 24px 20px', borderTop: '1px solid #e1e3e5',
        }}>
          <button
            type="button"
            onClick={handleClose}
            style={{
              padding: '8px 20px', border: '1px solid #c9cccf', borderRadius: '8px',
          ...
          <button
            ...
            style={{
              ...
              fontSize: '14px', fontWeight: 600, cursor: empresa.trim() && !saving ? 'pointer' : 'default',
              color: '#fff',
            }}
          >
