...
import { ExportIcon, NoteIcon, QuestionCircleIcon } from '@shopify/polaris-icons';
      ...
      <Modal.Section>
        <BlockStack gap="400">
          <Text as="p" variant="bodyMd">
            ¿Cómo quieres importar tus productos?
          </Text>
          <RadioButton
            ...
            helpText={
              <Text as="span" tone="subdued">
                ...
                <Link
                  url="https://kiosko-blob.s3.us-east-2.amazonaws.com/formato_inventario_kiosco.csv"
                  target="_blank"
                >
                  Descargar CSV de ejemplo
                </Link>
  ...
  return (
    ...
    >
      <Modal.Section>
        <BlockStack gap="400">
          <Text as="p" variant="bodyMd">
            Este archivo CSV puede actualizar toda la información del producto. Para actualizar solo las cantidades de
            inventario, usa el <Link url="#">Archivo CSV para inventario</Link>.
          </Text>
        ...
        <BlockStack gap="400">
          ...
          <BlockStack gap="200">
            ...
            <Text as="p" variant="bodyMd" tone="subdued">
              De forma predeterminada, todas las exportaciones incluyen: nombre completo, Identificación, dirección,
              correo electrónico, número de teléfono, empresa, consentimiento de marketing, pedidos, exenciones de
              impuestos.
            </Text>
            <Checkbox label="Etiquetas de cliente" checked={includeTags} onChange={setIncludeTags} />
            <Checkbox label="Metacampos de cliente" checked={includeMetafields} onChange={setIncludeMetafields} />
          </BlockStack>
  ...
  return (
    ...
    >
      <Modal.Section>
        <BlockStack gap="400">
          <Text as="p" variant="bodyMd">
            ¿Cómo quieres importar tus clientes?
          </Text>
          <RadioButton
