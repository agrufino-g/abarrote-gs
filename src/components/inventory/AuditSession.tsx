  ...
  return (
    <BlockStack gap="400">
      ...
      >
        <p>
          {isCompleted
            ? 'Esta auditoría ha sido finalizada y los ajustes de inventario aplicados.'
            : 'Ingresa las cantidades reales que encontraste físicamente en el almacén.'}
        </p>
      </Banner>
        ...
        <IndexTable
          ...
          headings={
            isCompleted
              ...
              : [{ title: 'Producto' }, { title: 'Sist.' }, { title: 'Físico (Tu conteo)' }]
          }
          selectable={false}
        >
          {rowMarkup}
      ...
      {!isCompleted && (
        <InlineStack align="end" gap="400">
          ...
          <Button variant="primary" tone="success" loading={isSubmitting} onClick={handleFinishAudit} icon={CheckIcon}>
